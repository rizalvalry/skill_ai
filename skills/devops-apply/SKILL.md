...
3. **Load method** — `developer` skill (Skill tool: `skill-ai:developer`), `Lane: FULL` always for pipeline/IaC/deployment files. Load the `azure` (or relevant provider) reference skill when applicable.
